...
<div class="content-container">
    ...
    <form action="" id="signupform" method="POST">
        <div class="page-title" style="width: 40%; display: block; margin: auto;"> Log In </div>
        <a href="signupform.php" id="loginform-link"> don't have an account? sign up. </a>
        <br> <br>
    ...
    <div class="md-form" class="signupbox" style="width: 40%!important; text-align: center; display: block; margin: auto;  margin-bottom: 50px!important;">
        ...
        <br><input type="submit" class="selectform" style=" width: 40%; display: block; margin: auto; font-weight: 600; font-size: 20pt; text-align: left;"value="Log In">
    </form>
...
if ($count<1){
    echo "<span style=' width: 40%; display:  block; margin: auto;'> <a href='signupform.php' id='loginform-link' style='width:100%;'> Username not found. Sign up. </a> </span>";
    exit;
}
...
$_SESSION['loggedin'] = 'yes';
    ...
    $sql="SELECT * FROM favGenres_view WHERE username='$username' and password='$password'";
...
{
echo "<span style=' width: 40%; display:  block; margin: auto;'> Invalid username or password </span>";
}
